...
public class Google_Home_page extends Reusable_Annotations {
    ...
    public void searchUserValue(String uservalue){
        Reusable_POM_Logger_Repeat.sendKeysAction(driver,searchField,uservalue,logger,"Search Field");
    }//end of search field method

    public void submitOnGoogleSearch(){
        Reusable_POM_Logger_Repeat.submitAction(driver,googleSearchButton,logger,"Google Search Button");
